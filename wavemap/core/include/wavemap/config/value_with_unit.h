#ifndef WAVEMAP_CONFIG_VALUE_WITH_UNIT_H_
#define WAVEMAP_CONFIG_VALUE_WITH_UNIT_H_
...
#include "wavemap/config/impl/value_with_unit_inl.h"

#endif  // WAVEMAP_CONFIG_VALUE_WITH_UNIT_H_
