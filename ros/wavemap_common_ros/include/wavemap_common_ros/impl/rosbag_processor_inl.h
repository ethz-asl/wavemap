#ifndef WAVEMAP_COMMON_ROS_IMPL_ROSBAG_PROCESSOR_INL_H_
#define WAVEMAP_COMMON_ROS_IMPL_ROSBAG_PROCESSOR_INL_H_
...
#endif  // WAVEMAP_COMMON_ROS_IMPL_ROSBAG_PROCESSOR_INL_H_
