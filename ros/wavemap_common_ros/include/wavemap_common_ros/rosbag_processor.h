#ifndef WAVEMAP_COMMON_ROS_ROSBAG_PROCESSOR_H_
#define WAVEMAP_COMMON_ROS_ROSBAG_PROCESSOR_H_
...
#include "wavemap_common_ros/impl/rosbag_processor_inl.h"

#endif  // WAVEMAP_COMMON_ROS_ROSBAG_PROCESSOR_H_
