#ifndef WAVEMAP_RVIZ_PLUGIN_VISUALS_MULTI_RESOLUTION_SLICE_VISUAL_H_
#define WAVEMAP_RVIZ_PLUGIN_VISUALS_MULTI_RESOLUTION_SLICE_VISUAL_H_
...
#endif  // WAVEMAP_RVIZ_PLUGIN_VISUALS_MULTI_RESOLUTION_SLICE_VISUAL_H_
