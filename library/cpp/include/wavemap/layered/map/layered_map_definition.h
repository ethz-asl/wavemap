...
#include <wavemap/layered/io/descriptor_layered_map_io.h>
#include <wavemap/layered/map/layered_map.h>
#include <wavemap/layered/schema/schema_continuous_traits.h>
...
struct LayeredMapDefinition {
  ...
  using Map = LayeredMap<ContinuousLayers, ContinuousArithmetic,
                         DiscreteLayers, ContinuousMapBackend>;
