#ifndef WAVEMAP_CORE_UTILS_EDIT_SAMPLE_H_
...
template <typename MapT, typename SamplingFn>
void sample(MapT& map, SamplingFn sampling_function,
  ...
  map.forEachBlock([&thread_pool, &sampling_function, tree_height,
...
#endif  // WAVEMAP_CORE_UTILS_EDIT_SAMPLE_H_
