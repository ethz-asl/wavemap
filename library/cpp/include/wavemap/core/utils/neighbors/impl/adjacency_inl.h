#ifndef WAVEMAP_CORE_UTILS_NEIGHBORS_IMPL_ADJACENCY_INL_H_
#define WAVEMAP_CORE_UTILS_NEIGHBORS_IMPL_ADJACENCY_INL_H_
...
#endif  // WAVEMAP_CORE_UTILS_NEIGHBORS_IMPL_ADJACENCY_INL_H_
