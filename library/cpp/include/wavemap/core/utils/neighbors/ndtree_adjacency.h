#ifndef WAVEMAP_CORE_UTILS_NEIGHBORS_NDTREE_ADJACENCY_H_
#define WAVEMAP_CORE_UTILS_NEIGHBORS_NDTREE_ADJACENCY_H_
...
#include "wavemap/core/utils/neighbors/impl/ndtree_adjacency_inl.h"

#endif  // WAVEMAP_CORE_UTILS_NEIGHBORS_NDTREE_ADJACENCY_H_
