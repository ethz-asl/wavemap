#ifndef WAVEMAP_CORE_UTILS_ITERATE_POINTCLOUD_ITERATOR_H_
#define WAVEMAP_CORE_UTILS_ITERATE_POINTCLOUD_ITERATOR_H_
...
#endif  // WAVEMAP_CORE_UTILS_ITERATE_POINTCLOUD_ITERATOR_H_
