#ifndef WAVEMAP_CORE_UTILS_QUERY_OCCUPANCY_CLASSIFIER_H_
#define WAVEMAP_CORE_UTILS_QUERY_OCCUPANCY_CLASSIFIER_H_
...
#endif  // WAVEMAP_CORE_UTILS_QUERY_OCCUPANCY_CLASSIFIER_H_
