#ifndef WAVEMAP_CORE_MAP_VOLUMETRIC_OCTREE_H_
#define WAVEMAP_CORE_MAP_VOLUMETRIC_OCTREE_H_
...
#include "wavemap/core/map/impl/volumetric_octree_inl.h"

#endif  // WAVEMAP_CORE_MAP_VOLUMETRIC_OCTREE_H_
