...
#include "wavemap/core/integrator/projection_model/impl/pinhole_camera_projector_inl.h"

#endif  // WAVEMAP_CORE_INTEGRATOR_PROJECTION_MODEL_PINHOLE_CAMERA_PROJECTOR_H_
