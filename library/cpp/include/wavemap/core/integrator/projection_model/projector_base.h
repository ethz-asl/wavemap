#ifndef WAVEMAP_CORE_INTEGRATOR_PROJECTION_MODEL_PROJECTOR_BASE_H_
#define WAVEMAP_CORE_INTEGRATOR_PROJECTION_MODEL_PROJECTOR_BASE_H_
...
#include "wavemap/core/integrator/projection_model/impl/projector_base_inl.h"
