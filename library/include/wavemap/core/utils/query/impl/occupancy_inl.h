#ifndef WAVEMAP_CORE_UTILS_QUERY_IMPL_OCCUPANCY_INL_H_
#define WAVEMAP_CORE_UTILS_QUERY_IMPL_OCCUPANCY_INL_H_
...
#endif  // WAVEMAP_CORE_UTILS_QUERY_IMPL_OCCUPANCY_INL_H_
