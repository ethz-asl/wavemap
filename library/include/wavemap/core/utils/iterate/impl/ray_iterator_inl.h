#ifndef WAVEMAP_CORE_UTILS_ITERATE_IMPL_RAY_ITERATOR_INL_H_
#define WAVEMAP_CORE_UTILS_ITERATE_IMPL_RAY_ITERATOR_INL_H_
...
#endif  // WAVEMAP_CORE_UTILS_ITERATE_IMPL_RAY_ITERATOR_INL_H_
