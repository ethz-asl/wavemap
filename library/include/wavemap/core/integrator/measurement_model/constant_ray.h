#ifndef WAVEMAP_CORE_INTEGRATOR_MEASUREMENT_MODEL_CONSTANT_RAY_H_
#define WAVEMAP_CORE_INTEGRATOR_MEASUREMENT_MODEL_CONSTANT_RAY_H_
...
#endif  // WAVEMAP_CORE_INTEGRATOR_MEASUREMENT_MODEL_CONSTANT_RAY_H_
