#ifndef WAVEMAP_CORE_INTEGRATOR_IMPL_INTEGRATOR_BASE_INL_H_
#define WAVEMAP_CORE_INTEGRATOR_IMPL_INTEGRATOR_BASE_INL_H_
...
#endif  // WAVEMAP_CORE_INTEGRATOR_IMPL_INTEGRATOR_BASE_INL_H_
