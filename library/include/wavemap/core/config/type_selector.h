#ifndef WAVEMAP_CORE_CONFIG_TYPE_SELECTOR_H_
#define WAVEMAP_CORE_CONFIG_TYPE_SELECTOR_H_
...
#include "wavemap/core/config/impl/type_selector_inl.h"

#endif  // WAVEMAP_CORE_CONFIG_TYPE_SELECTOR_H_
