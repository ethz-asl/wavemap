#ifndef WAVEMAP_INTEGRATOR_PROJECTIVE_IMPL_SCANWISE_INTEGRATOR_INL_H_
#define WAVEMAP_INTEGRATOR_PROJECTIVE_IMPL_SCANWISE_INTEGRATOR_INL_H_

namespace wavemap {
inline FloatingPoint ScanwiseIntegrator::computeUpdate(
...
#endif  // WAVEMAP_INTEGRATOR_PROJECTIVE_IMPL_SCANWISE_INTEGRATOR_INL_H_
