#ifndef WAVEMAP_MAP_HASHED_WAVELET_OCTREE_BLOCK_H_
#define WAVEMAP_MAP_HASHED_WAVELET_OCTREE_BLOCK_H_
...
#include "wavemap/map/impl/hashed_wavelet_octree_block_inl.h"

#endif  // WAVEMAP_MAP_HASHED_WAVELET_OCTREE_BLOCK_H_
