#ifndef WAVEMAP_MAP_WAVELET_OCTREE_H_
#define WAVEMAP_MAP_WAVELET_OCTREE_H_
...
#include "wavemap/map/impl/wavelet_octree_inl.h"

#endif  // WAVEMAP_MAP_WAVELET_OCTREE_H_
