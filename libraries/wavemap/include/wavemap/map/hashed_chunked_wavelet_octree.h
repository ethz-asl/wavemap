#ifndef WAVEMAP_MAP_HASHED_CHUNKED_WAVELET_OCTREE_H_
#define WAVEMAP_MAP_HASHED_CHUNKED_WAVELET_OCTREE_H_
...
#include "wavemap/map/impl/hashed_chunked_wavelet_octree_inl.h"

#endif  // WAVEMAP_MAP_HASHED_CHUNKED_WAVELET_OCTREE_H_
