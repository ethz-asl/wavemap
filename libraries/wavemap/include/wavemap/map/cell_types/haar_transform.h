#ifndef WAVEMAP_MAP_CELL_TYPES_HAAR_TRANSFORM_H_
#define WAVEMAP_MAP_CELL_TYPES_HAAR_TRANSFORM_H_
...
#include "wavemap/map/cell_types/impl/haar_transform_inl.h"

#endif  // WAVEMAP_MAP_CELL_TYPES_HAAR_TRANSFORM_H_
