#ifndef WAVEMAP_MAP_IMPL_HASHED_WAVELET_OCTREE_BLOCK_INL_H_
#define WAVEMAP_MAP_IMPL_HASHED_WAVELET_OCTREE_BLOCK_INL_H_
...
#endif  // WAVEMAP_MAP_IMPL_HASHED_WAVELET_OCTREE_BLOCK_INL_H_
