#ifndef WAVEMAP_UTILS_SDF_BUCKET_QUEUE_H_
#define WAVEMAP_UTILS_SDF_BUCKET_QUEUE_H_
...
#include "wavemap/utils/sdf/impl/bucket_queue_inl.h"

#endif  // WAVEMAP_UTILS_SDF_BUCKET_QUEUE_H_
