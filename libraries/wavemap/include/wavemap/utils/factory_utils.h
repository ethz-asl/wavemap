#ifndef WAVEMAP_UTILS_FACTORY_UTILS_H_
#define WAVEMAP_UTILS_FACTORY_UTILS_H_
...
#include "wavemap/utils/impl/factory_utils_inl.h"

#endif  // WAVEMAP_UTILS_FACTORY_UTILS_H_
