#ifndef WAVEMAP_UTILS_QUERY_IMPL_POINT_SAMPLER_INL_H_
#define WAVEMAP_UTILS_QUERY_IMPL_POINT_SAMPLER_INL_H_
...
#endif  // WAVEMAP_UTILS_QUERY_IMPL_POINT_SAMPLER_INL_H_
