#ifndef WAVEMAP_3D_INTEGRATOR_MEASUREMENT_MODEL_MEASUREMENT_MODEL_H_
#define WAVEMAP_3D_INTEGRATOR_MEASUREMENT_MODEL_MEASUREMENT_MODEL_H_
...
class MeasurementModel {
 public:
  ...
  static constexpr FloatingPoint kRangeMax = 15.f;
  ...
  Point3D getEndPointOrMaxRange() const {
  ...
  virtual Index3D getBottomLeftUpdateIndex() const = 0;
  virtual Index3D getTopRightUpdateIndex() const = 0;

  virtual FloatingPoint computeUpdateAt(const Index3D& index) const = 0;
...
#endif  // WAVEMAP_3D_INTEGRATOR_MEASUREMENT_MODEL_MEASUREMENT_MODEL_H_
