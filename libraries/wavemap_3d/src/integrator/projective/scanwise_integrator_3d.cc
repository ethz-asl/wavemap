...
namespace wavemap {
void ScanwiseIntegrator3D::integratePointcloud(
...
void ScanwiseIntegrator3D::integrateRangeImage(
    const PosedRangeImage2D& range_image) {
  importRangeImage(range_image);
  updateMap();
}

void ScanwiseIntegrator3D::importPointcloud(
...
void ScanwiseIntegrator3D::importRangeImage(
