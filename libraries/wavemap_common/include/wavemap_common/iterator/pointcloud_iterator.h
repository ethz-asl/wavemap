#ifndef WAVEMAP_COMMON_ITERATOR_POINTCLOUD_ITERATOR_H_
#define WAVEMAP_COMMON_ITERATOR_POINTCLOUD_ITERATOR_H_
...
#endif  // WAVEMAP_COMMON_ITERATOR_POINTCLOUD_ITERATOR_H_
